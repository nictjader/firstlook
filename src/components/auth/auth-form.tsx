...
export default function AuthForm() {
  ...
  useEffect(() => {
    // This effect initializes the Google GSI client and renders the button.
    ...
    // Initialize the GSI client for One Tap and the Redirect flow
    ...
    // Manually render the button in our target div. This is the key fix.
      ...
      <CardContent className="flex flex-col gap-4">
        {googleClientId && appUrl ? (
            ...
            <div className="text-center text-sm text-muted-foreground p-4 bg-muted/50 rounded-md">
                ...
                Google Sign-In is not configured. Please ensure environment variables are set.
            </div>
        )}
