    ...
    <div className="max-w-3xl">
      <Card>
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          ...
          <h2>10. Contact Us</h2>
          <p>If you have any questions about these Terms, please contact us at <a href="mailto:contact@trysiren.com" className="underline hover:text-primary">contact@trysiren.com</a>.</p>
        </CardContent>
      </Card>
    </div>
  );
