...
// This is the crucial fix: Force this page to be dynamically rendered on the server at request time.
// This ensures that client-side hooks like useAuth() within ReaderView have the necessary context.
